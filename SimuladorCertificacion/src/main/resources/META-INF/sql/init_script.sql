...
insert into opcionrespuestaentity(id, pregunta_id, orden, opcioncorrecta, contenido) values (next value for hibernate_sequence, 12, 1, true, 'El código compila bien pero se lanza una excepción DateTimeException porque el año no puede ser menor a 1970 (tiempo Unix/POSIX).');
...
insert into opcionrespuestaentity(id, pregunta_id, orden, opcioncorrecta, contenido) values (next value for hibernate_sequence, 13, 1, true, 'ocurre un error de compilación puesto que no se ha llamado close() en los recursos: Connection, Statement y ResultSet');
...
insert into opcionrespuestaentity(id, pregunta_id, orden, opcioncorrecta, contenido) values (next value for hibernate_sequence, 15, 1, true, 'Se compila pero arroja una excepción del tipo java.io.FileNotFoundException');
...
insert into opcionrespuestaentity(id, pregunta_id, orden, opcioncorrecta, contenido) values (next value for hibernate_sequence, 16, 1, true, 'Se compila pero arroja una excepción del tipo java.io.FileNotFoundException e');
...
insert into opcionrespuestaentity(id, pregunta_id, orden, opcioncorrecta, contenido) values (next value for hibernate_sequence, 18, 1, true, 'el código compila bien pero se arroja la excepción NullPointerException al tratar de evaluar la expresión arg > 0');
...
insert into opcionrespuestaentity(id, pregunta_id, orden, opcioncorrecta, contenido) values (next value for hibernate_sequence, 19, 1, true, 'el código no compila puesto que la clase Terrestre implementa Atacante pero no implementa el método atacar()');
...
insert into opcionrespuestaentity(id, pregunta_id, orden, opcioncorrecta, contenido) values (next value for hibernate_sequence, 20, 1, true, 'el código no compila puesto que count() no está definido');
...
-- asociar temas de certificación a las preguntas
